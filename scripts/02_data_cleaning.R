...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/brazil_raw.csv",  
           sex="ALL", climate = "TROPICAL", drop_juveniles = TRUE, migratory_status = "NON", brazil=TRUE, drop_frags = FALSE,
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/panama_raw.csv",  
           sex="ALL", climate = "TROPICAL", drop_juveniles = TRUE, migratory_status = "NON", 
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/powdermill_raw.csv",  
           sex="ALL", climate = "TEMPERATE", drop_juveniles = TRUE, migratory_status = "NON", 
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/brazil_raw.csv",  
           sex="MALES", climate = "TROPICAL", drop_juveniles = TRUE, migratory_status = "NON", brazil=TRUE, drop_frags = FALSE,
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/panama_raw.csv",  
           sex="MALES", climate = "TROPICAL", drop_juveniles = TRUE, migratory_status = "NON", 
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/powdermill_raw.csv",  
           sex="MALES", climate = "TEMPERATE", drop_juveniles = TRUE, migratory_status = "NON", 
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/brazil_raw.csv",  
           sex="FEMALES", climate = "TROPICAL", drop_juveniles = TRUE, migratory_status = "NON", brazil=TRUE,
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/panama_raw.csv",  
           sex="FEMALES", climate = "TROPICAL", drop_juveniles = TRUE, migratory_status = "NON", 
...
clean_data(file_path = "~/Dropbox/Bird_body_size-analysis/bird_body_size/data/powdermill_raw.csv",  
           sex="FEMALES", climate = "TEMPERATE", drop_juveniles = TRUE, migratory_status = "NON", 
